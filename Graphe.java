...
public class Graphe {
    ...
    private List<Integer> victimes = null;
    private List<Integer> hopitaux = null;
    ...
    public Graphe(Map<Integer, List<Integer>> mapC, List<Integer> victimesC, List<Integer> hopitauxC) {
        ...
        if (mapC!=null){
            this.map = mapC;
        }else{this.map = new LinkedHashMap<Integer, List<Integer>>(); }
        if (victimesC!=null) {
            this.victimes = victimesC;
        }else{this.victimes = new LinkedList<Integer>(); }
        if (hopitauxC!=null) {
            this.hopitaux = hopitauxC;
        }else{this.hopitaux = new LinkedList<Integer>(); }
    }
